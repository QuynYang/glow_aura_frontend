...
import { Button } from '../../../components/ui/Button'; // Lưu ý: chỉnh lại đường dẫn import Button nếu cần
import { SkinQuizModal } from './SkinQuizModal';

export const PromoSection = () => {
  // State quản lý việc đóng/mở bảng câu hỏi AI
